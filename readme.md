...
1. [X] Ability to delete a specific Koala from the database.  
2. [X] Confirmation dialog before deleting (research SweetAlert).
3. [X] Ability to make koalas toggle between ready for transfer and NOT ready for transfer.
4. [x] Add form validation, additional styling and a README.md.
